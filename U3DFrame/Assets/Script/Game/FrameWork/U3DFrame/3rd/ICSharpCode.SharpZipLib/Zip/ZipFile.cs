...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		public ZipFile(FileStream file)
		{
			...
			if (!file.CanSeek) {
				throw new ArgumentException("Stream is not seekable", file.Name);
			}
		...
		public ZipFile(Stream stream)
		{
			...
			if (!stream.CanSeek) {
                throw new ArgumentException("Stream is not seekable", stream.ToString());
			}
		...
		public static ZipFile Create(Stream outStream)
		{
			...
			if (!outStream.CanWrite) {
				throw new ArgumentException("Stream is not writeable", outStream.ToString());
			}

			if (!outStream.CanSeek) {
                throw new ArgumentException("Stream is not seekable", outStream.ToString());
			}
		...
		public void Add(string fileName, CompressionMethod compressionMethod)
		{
			...
			if (!ZipEntry.IsCompressionMethodSupported(compressionMethod)) {
                throw new ArgumentOutOfRangeException(compressionMethod.ToString());
			}
		...
		{
			if (dataSource == null) {
                throw new ArgumentNullException("IStaticDataSource");
			}
